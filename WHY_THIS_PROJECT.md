...
**Human Resources Escalation Triage** is not a static prompt demo. It is a runnable full-stack AI application for **Human Resources Escalation Triage Simple RAG - Beginner Custom 19** that demonstrates the core expectations of a **Simple RAG** project at **Beginner** difficulty.
