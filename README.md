# Human Resources Escalation Triage

## Project Overview

Human Resources Escalation Triage is a complete full-stack AI project for **Simple RAG** at **Beginner** difficulty. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.

Human Resources Escalation Triage involves identifying and addressing employee concerns, resolving conflicts, and escalating issues to higher management when necessary.
...
```text
ai-simple-rag-human-resources-escalation-triage-simple-rag-beginner-custom-19/
  backend/
app/
  main.py
  config.py
...
- Employee concerns must be addressed within 24 hours
- Conflicts must be resolved within 48 hours
- Employee satisfaction must be monitored regularly
