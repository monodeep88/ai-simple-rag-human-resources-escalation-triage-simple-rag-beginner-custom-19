...
This is a Beginner **Simple RAG** project for **Human Resources Escalation Triage Simple RAG - Beginner Custom 19**. It demonstrates a React user interface, FastAPI backend, retrieval/workflow pipeline, stored run history, Docker setup, and tests.
