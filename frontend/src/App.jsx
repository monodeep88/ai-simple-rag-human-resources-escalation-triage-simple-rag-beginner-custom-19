...
const PROJECT_SUBJECT = "Human Resources Escalation Triage Simple RAG - Beginner Custom 19";
const DOMAIN_SUMMARY = "Human Resources Escalation Triage involves identifying and addressing employee concerns, resolving conflicts, and escalating issues to higher management when necessary.";
const USER_PERSONA = "HR Manager: Responsible for managing employee concerns, resolving conflicts, and escalating issues to higher management when necessary.";
const STARTER_QUESTIONS = ["What are the common employee concerns?", "How can we improve conflict resolution?", "What are the key factors affecting employee satisfaction?"];
